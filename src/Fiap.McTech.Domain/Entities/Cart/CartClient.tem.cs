...
namespace Fiap.McTech.Domain.Entities.Cart
{
    ...
    public partial class CartClient
    {
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="CartClient.Item"/> class with specified parameters.
            /// </summary>
            ...
            public Item(string name, int quantity, decimal value, Guid productId, Guid cartClientId)
            {
                Name = name;
                Quantity = quantity;
                Value = value;
