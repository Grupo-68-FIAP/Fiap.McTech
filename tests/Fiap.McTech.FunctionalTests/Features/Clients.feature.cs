...
#line hidden
        ...
        public GerenciamentoDeClientesFeature(GerenciamentoDeClientesFeature.FixtureData fixtureData, Fiap_McTech_FunctionalTests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("pt"), "Features", "Gerenciamento de Clientes", @"  Cen�rio: Criar um novo cliente
    Dado que eu tenho um ID de cliente �nico
    E que eu tenho os detalhes do cliente
    Quando eu crio um novo cliente
    Entao o status da resposta deve ser 201 Created
  ...
  Cen�rio: Criar um cliente com CPF inv�lido
    ...
    Quando eu crio um novo cliente
    Entao o status da resposta deve ser 400 BadRequest
    E a mensagem de erro deve ser ""CPF inv�lido""", ProgrammingLanguage.CSharp, ((string[])(null)));
